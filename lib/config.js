...
export const SHEET_HEADERS = {
  ...
  'Center Card' : ['Center Code','Center Name','ColC','ColD','ColE','Signed Agreement','Phone','Email','Country','Payment Method'],
};
...
export const CRITERIA_LIST_SHEET_NAME = 'Criteria List';
